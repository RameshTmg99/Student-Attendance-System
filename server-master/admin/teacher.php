        ...
        <option value="a">Admin</option>
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub2' name = 'sub2' >";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub3' name = 'sub3' >";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub4' name = 'sub4' >";
           ...
           <div class="form-group">
            ...
            <?php 
              ...
              $query->execute();
              $r = $query->get_result();
              echo "<select class='form-control sub5' name = 'sub5' >";
